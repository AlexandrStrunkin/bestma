<?
    ...
    $MESS["QUANTITY_1"] = "Почти закончился ";
    $MESS["QUANTITY_1_ADD"] = "(Менее 5шт.)";
    $MESS["QUANTITY_2"] = "Очень мало ";
    $MESS["QUANTITY_2_ADD"] = "(От 5 до 10 шт.)";
    $MESS["QUANTITY_3"] = "Заканчивается ";
    $MESS["QUANTITY_3_ADD"] = "(От 10 до 50 шт.)";
    $MESS["QUANTITY_4"] = "Очень много ";
    $MESS["QUANTITY_4_ADD"] = "(Свыше 50 шт.)";
    $MESS["RRC_TEXT"] = "Рекоменд. розн. цена";
    $MESS["PRICE_TITLE_CATEGORY"] = "Категория цен";
    $MESS["PRICE_TITLE_DISCOUNT"] = "Экономия";
    $MESS["PRICE_TITLE_WHOLESALE"] = "Оптовая цена";
?>