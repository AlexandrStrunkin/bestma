                    ...
                    <td class="image_block">
                        <div class="image_wrapper_block">
                            ...
                            <?foreach($arItem['PROPERTIES']['MORE_PHOTO']['VALUE'] as $slider_photo) { 
                                $img = CFile::ResizeImageGet($slider_photo, array("width" => 170, "height" => 170), BX_RESIZE_IMAGE_PROPORTIONAL, true, array());
                                $detailID = $detailID + 1;?>
                                <a href="<?=$arItem["DETAIL_PAGE_URL"]?>" class="thumb" style="display:none;">
                                    <img border="0" src="<?=$img["src"]?>"/>                                 
                                </a>                                           
                            <?}?>
                        </div>
                        ...
                        <?if( !(empty($arItem["PREVIEW_PICTURE"]) || empty($arItem["DETAIL_PICTURE"]))) {?> 
                            ...
                            $counter = 1;
                            ?>
                            <div class="photo_miniature list first active">
                            <?if( !empty($arItem["PREVIEW_PICTURE"]) ):?>
                                <?$img = CFile::ResizeImageGet($arItem["PREVIEW_PICTURE"]["ID"], array( "width" => 38, "height" => 38 ), BX_RESIZE_IMAGE_PROPORTIONAL, true, array());?> 
                                <img border="0" src="<?=$img["src"]?>"/>
                            <?elseif( !empty($arItem["DETAIL_PICTURE"])):?>
                            ...
                            <?foreach($arItem['PROPERTIES']['MORE_PHOTO']['VALUE'] as $slider_photo) { 
                                $counter = $counter + 1;
                                $img = CFile::ResizeImageGet($slider_photo, array("width" => 38, "height" => 38), BX_RESIZE_IMAGE_PROPORTIONAL, true, array());?>
                                <div class="photo_miniature list <? if ($counter == $miniatureCount) echo 'last'; ?>" <? if ($counter > $miniatureCount) echo 'style="display:none"'; ?>><img border="0" src="<?=$img["src"]?>"/></div>                                           
                            <?}?>
                        <?}?>
                        </div>
                    </td>
                            ...
                            <div class="cost prices clearfix">
                                ...
                                <?}else{?>
                                    ...
                                    <div class="list_price_block">
                                        <div class="list_price_title">
                                            <?= GetMessage('PRICE_TITLE_CATEGORY')?>
                                        </div>
                                        <div class="list_price_title">
                                            <?= GetMessage('PRICE_TITLE_DISCOUNT')?>
                                        </div>
                                        <div class="list_price_title">
                                            <?= GetMessage('PRICE_TITLE_WHOLESALE')?>
                                        </div>
                                    </div> 
