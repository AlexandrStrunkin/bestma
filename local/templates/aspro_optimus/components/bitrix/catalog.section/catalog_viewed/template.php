											...
											<?if( $arItem["OFFERS"]){?>
												...
												<div class="price only_price">
													<?if(strlen($minPrice["PRINT_VALUE"])):?>
														<?=$prefix;?> <?=($minPrice['PRINT_DISCOUNT_VALUE'] ? $minPrice['PRINT_DISCOUNT_VALUE'] : $minPrice['PRINT_VALUE']);?>
														<?if (($arParams["SHOW_MEASURE"]=="Y") && $strMeasure){?>
															<span class="measure">/<?=$strMeasure?></span>
														<?}?>
													<?endif;?>
												</div>
													...
													<?if($arPrice["CAN_ACCESS"]){
														...
														<div class="price only_price">
															<?if(strlen($arPrice["PRINT_VALUE"])):?>
																<?=($arPrice["PRINT_DISCOUNT_VALUE"] ? $arPrice["PRINT_DISCOUNT_VALUE"] : $arPrice["PRINT_VALUE"]);?>
																<?if (($arParams["SHOW_MEASURE"]=="Y") && $strMeasure){?>
																	<span class="measure">/<?=$strMeasure?></span>
																<?}?>
															<?endif;?>
